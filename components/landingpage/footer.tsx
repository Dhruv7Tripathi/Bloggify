...
const Footer = () => {
  ...
  return (
    <div className="border-t border-neutral-100 dark:border-white/[0.1] px-8 py-20 bg-white dark:bg-black">
      <div className="max-w-[87rem] mx-auto text-sm px-4 text-white flex sm:flex-row flex-col justify-between items-start ">
        <div>
          ...
          <div className="mt-2">
            ...
            <a className="dark:text-emerald-500 pl-1 font-medium text-white" target="__blank" href="https://github.com/dhruv7tripathi">@dhruv7tripathi</a>
          </div>
        </div>
        <div className="grid grid-cols-3 gap-10 items-start mt-10 md:mt-0">
          <div className="flex justify-center space-y-4 flex-col mt-4">
            <Link href='/'>
              <p className="hover:text-foreground/80 text-white">Home</p>
            </Link>
            <Link href='/blog'>
              <p className="hover:text-foreground/80 text-white">blogs</p>
            </Link>
            <Link href='/contact'>
              <p className="hover:text-foreground/80 text-white">Contact</p>
            </Link>
            <Link href='/about'>
